// Day 17 · Trilogie (ERP), Vidisha / Tejas: the questions of this trainer's part, picked from the day's combined bank in
...
const PICK = [9, 10, 21]; // 1-based numbers in the day file
